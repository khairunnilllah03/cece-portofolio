  ...
  return (
    <section id="projects" className="py-20 bg-transparent">
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* KOTAK UTAMA DENGAN HOVER GLOW RINGAN */}
        <motion.div
        ...
        >
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1.5 bg-cyan-500 mx-auto rounded-full transition-all duration-500 group-hover:w-32" />
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div key={index} className="group h-full">
                {/* CARD DENGAN EFEK HOVER LIFT & GLOW */}
                <div className="h-full flex flex-col rounded-[2.5rem] bg-white/80 dark:bg-[#0a192f] border border-cyan-100 dark:border-white/5 shadow-xl overflow-hidden transition-all duration-300 
                  hover:-translate-y-3 hover:border-cyan-400 hover:shadow-[0_20px_40px_rgba(6,182,212,0.15)]">
                  ...
                  <div className="relative h-56 w-full overflow-hidden">
                    ...
                    />
                    <div className="absolute top-4 right-4 p-2.5 bg-white/90 dark:bg-[#112240]/90 rounded-2xl shadow-lg text-cyan-600 dark:text-cyan-400 transition-transform group-hover:rotate-12">
                      {project.icon}
                    </div>
                  </div>
                  ...
                  <div className="p-7 flex flex-col flex-grow">
                    ...
                    {/* BUTTON DENGAN EFEK BOUNCE */}
                    <div className="mt-auto">
                      <Button 
                        variant="outline" 
                        className="w-full rounded-2xl border-cyan-500/50 text-cyan-600 dark:text-cyan-400 font-bold italic transition-all duration-300 hover:bg-cyan-500 hover:text-white active:scale-95"
                        asChild
                      >
